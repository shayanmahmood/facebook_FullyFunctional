...
export const renderProfile = user => {
    let markUp = `
<header class="header" style='border-bottom:1px solid grey'>
    <div class="container">
        ...
        <div class="header-user-container">
            ...
            <div class="header-user-containerBox">
                <img src="${user.image}" alt="" class="header-user-containerBoxImg">
            </div>
        </div>
    </div>
...
<div class="profileBoxImgCon">
    <img src="${user.image}"
        alt="" class="profileBoxImg">
    <p class="profileBoxtxt">${user.userName + ' ' + user.secondName}</p>
</div>
</div>

<div class="mainPROFI">
<div class="mainPROFIIntro">
    <div class="intro">
        <p class="IntroTxt">Intro</p>
        <button class="BTN_Intro" value="Add Bio">Add Bio</button>
        <button class="BTN_Intro" value="Add Bio">Add Hobbies</button>
    </div>
</div>
<div class="mainPROFIPost">
<button class='showMEy'>Show My Posts</button>
